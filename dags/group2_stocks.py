...
UPDATE_DIM_TABLE =
f"CREATE OR REPLACE TRANSIENT TABLE {DIM_TABLE} as select * from US_STOCKS_DAILY.PUBLIC.COMPANY_PROFILE;"

UPDATE_FACT_TABLE =
f"INSERT INTO {FACT_TABLE} as select * from US_STOCKS_DAILY.PUBLIC.STOCK_HISTORY WHERE DATE = getDate();"
